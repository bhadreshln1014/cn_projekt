...
\begin{titlepage}
    ...
    {\large [Student Name]}\\
    {\large Roll No: [Roll Number]}\\[2cm]
    
    {\large\textbf{Course Instructor:}}\\[0.5cm]
    {\large [Professor Name]}\\[3cm]
...
\begin{verbatim}
pip install PyQt6 opencv-python pyaudio numpy mss pillow
\end{verbatim}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.9\textwidth}{\centering
        ...
        Showing video grid, control bar, and side panel with chat/people/files tabs\\
        \vspace{4cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.6\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Connection Dialog\\
        Server IP, port, and username input fields\\
        \vspace{2cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.9\textwidth}{\centering
        ...
        Multiple participant video feeds displayed in dynamic grid layout\\
        \vspace{3.5cm}
    }}
    \caption{Video Conference with Multiple Participants}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.9\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Screen Sharing View\\
        Presenter's screen being shared with all participants\\
        \vspace{3.5cm}
    }}
    \caption{Screen Sharing in Progress}
    \label{fig:screen-sharing}
\end{figure}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.7\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Chat Panel\\
        Group messages and private messages with timestamps\\
        Private messages indicated with [LOCK] icon\\
        \vspace{3cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.6\textwidth}{\centering
        ...
        List of connected users with online status indicators\\
        Video/audio status and private message buttons\\
        \vspace{2.5cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.7\textwidth}{\centering
        ...
        \vspace{0.5cm}
        File Sharing Panel\\
        List of shared files with metadata (name, size, uploader)\\
        Upload and download buttons with progress tracking\\
        \vspace{3cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.8\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Settings Panel\\
        Configuration options for video quality, audio settings,\\
        screen sharing parameters, and file transfer limits\\
        \vspace{3cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.8\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Notification System\\
        User join/leave notifications and chat message alerts\\
        Displayed as toast notifications with user status updates\\
        \vspace{2.5cm}
    }}
    \caption{Notification System (Join/Leave and Chat Alerts)}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.7\textwidth}{\centering
        ...
        One-on-one private messaging with individual participants\\
        Showing private message thread with [LOCK] icon indicator\\
        \vspace{3cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.9\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Tiled Layout Mode\\
        Grid view with equal-sized video tiles for all participants\\
        Dynamic grid sizing (1x1, 2x2, 3x3, 4x3 based on participant count)\\
        \vspace{3.5cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.9\textwidth}{\centering
        ...
        Main speaker video in large view with thumbnails of other participants\\
        Active speaker automatically highlighted in spotlight\\
        \vspace{3.5cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.6\textwidth}{\centering
        ...
        \vspace{0.5cm}
        Joining Window\\
        Server IP address and username input fields\\
        Port configuration and Connect button\\
        \vspace{2.5cm}
    }}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.7\textwidth}{\centering
        ...
        \textbf{[SCREENSHOT PLACEHOLDER]}\\
        \vspace{0.5cm}
        Screen Share Conflict Warning\\
        Warning dialog displayed when attempting to share screen\\
        while another user is already presenting\\
        Message: "Screen sharing in progress by [Username]. Please wait."\\
        \vspace{2cm}
    }}
...
\begin{enumerate}[itemsep=10pt]
    \item Python Software Foundation. (2024). \textit{Python Documentation}. \url{https://docs.python.org/3/}
    
    \item Riverbank Computing. (2024). \textit{PyQt6 Documentation}. \url{https://www.riverbankcomputing.com/static/Docs/PyQt6/}
    
    \item OpenCV Team. (2024). \textit{OpenCV Python Documentation}. \url{https://docs.opencv.org/}
    
    \item PyAudio Contributors. (2024). \textit{PyAudio Documentation}. \url{https://people.csail.mit.edu/hubert/pyaudio/}
    
    \item Tanenbaum, A. S., \& Wetherall, D. J. (2011). \textit{Computer Networks} (5th ed.). Prentice Hall.
    
    \item Kurose, J. F., \& Ross, K. W. (2017). \textit{Computer Networking: A Top-Down Approach} (7th ed.). Pearson.
    
    \item Peterson, L. L., \& Davie, B. S. (2012). \textit{Computer Networks: A Systems Approach} (5th ed.). Morgan Kaufmann.
    
    \item Stevens, W. R., Fenner, B., \& Rudoff, A. M. (2004). \textit{UNIX Network Programming, Volume 1: The Sockets Networking API} (3rd ed.). Addison-Wesley.
\end{enumerate}
